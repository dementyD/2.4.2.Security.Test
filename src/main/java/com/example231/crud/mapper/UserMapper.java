...
import com.example231.crud.service.DaDataService;
import com.example231.crud.service.DuckService;
...
public class UserMapper {
    ...
    @Autowired
    public UserMapper(RoleRepository roleRepository, UserService userService,
                      DaDataService daDataService, DuckService duckService) {
    ...
    private Avatar getAvatar(UserDTO userDTO) {
        Avatar avatar = duckService.getAvatar();
    ...
    private String getDaDataResponse(UserDTO userDTO) {
        ...
        coordsDTO.setRadius_meters(3000D);
        return daDataService.getPostDaData(coordsDTO);
    }
}
